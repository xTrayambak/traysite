+++
title = "An introduction to Madhyasthal's DCE pass"
date = 2025-08-29
+++

Madhyasthal is the [Bali JavaScript engine](https://github.com/ferus-web/bali)'s midtier JIT compiler.

**Note**: I made the bright decision of hosting the code snippet images on Catbox, as I had not set up an asset server yet. As a result, they're all gone. You can check out the relevant pieces of code [here](https://github.com/ferus-web/bali/tree/master/src/bali/runtime/compiler/madhyasthal) in Bali's source tree.
